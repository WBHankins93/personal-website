      ...
      <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              {project.links.map((link) => (
                <a
                  ...
                  className="project-signal-link inline-flex items-center gap-1.5 font-heading text-[0.9rem] font-semibold no-underline transition-colors"
                >
        ...
        <div className="mx-auto mt-16 max-w-5xl md:mt-24">
          ...
          <div className="border-t border-ink pt-10 text-center">
            ...
            <Link
              href="/projects"
              className="project-signal-link mt-4 inline-flex items-center gap-2 font-heading text-[1.15rem] font-semibold no-underline"
            >
