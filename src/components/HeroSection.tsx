    ...
    <section id="home" className="min-h-[80vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl md:text-2xl font-medium text-white font-heading">
            <TypingAnimation words={roles} className="text-blue-400 font-semibold" />
          </h2>

          <p className="text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed max-w-3xl mx-auto font-body">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              size="lg"
              className="bg-[#E07A5F] hover:bg-opacity-90 text-white px-8 py-3 text-lg group font-body"
            >
              Get In Touch
            ...
            <button
              ...
              className="px-6 py-2 bg-white text-slate-900 font-semibold rounded shadow hover:bg-slate-100 transition font-body"
            >
              View CV
            </button>
...
function Stat({
  ...
  return (
    <div className="text-white animate-float">
      <div className={`text-3xl font-bold font-mono ${color}`}>{title}</div>
      <div className="text-slate-300 font-body">{subtitle}</div>
    </div>
  );
}
