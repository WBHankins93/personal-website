...
const techIcons = [
  ...
  <Server key="server" className="w-full h-full" />, 
  <Shield key="shield" className="w-full h-full" />,
  <Code key="code" className="w-full h-full" />,
  <Monitor key="monitor" className="w-full h-full" />,
  <Settings key="settings" className="w-full h-full" />,
  <GitBranch key="gitbranch" className="w-full h-full" />,
  <Workflow key="workflow" className="w-full h-full" />,
  <BrainCircuit key="braincircuit" className="w-full h-full" />,
  <CloudCheck key="cloudcheck" className="w-full h-full" />,
  <Container key="container" className="w-full h-full" />,
  <GitFork key="gitfork" className="w-full h-full" />,
  <Network key="network" className="w-full h-full" />,
  <Rocket key="rocket" className="w-full h-full" />,
  <Puzzle key="puzzle" className="w-full h-full" />,
  <Database key="database" className="w-full h-full" />,
  
  // Docker brand icon
  <svg key="docker" className="w-full h-full" viewBox="0 0 24 24" fill="currentColor">
  ...
  // GitHub brand icon  
  <svg key="github" className="w-full h-full" viewBox="0 0 24 24" fill="currentColor">
