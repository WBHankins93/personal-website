...
import type { Project } from "@/data/projects"; // gets the exact union for category
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto">
              Infrastructure, automation, and platform work presented with clear visuals and fast scanning.
            </p>
          </div>
