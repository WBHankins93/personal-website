...
export const experiencesData = [
...

  {
    ...
    location: "Austin, TX",
    type: "past",
    logo: "/general-assembly-logo-Photoroom.png",
    note: "5-month full-time bootcamp • web development training",
    highlights: [
      { icon: "Code", text: "Core Fundamentals", metric: false },
      { icon: "Rocket", text: "Real-world project completion", metric: true },
      { icon: "Target", text: "Job placement success", metric: true },
      { icon: "CheckCircle", text: "Full-stack development", metric: false },
    ],
    achievements: [
      "Completed 5-month intensive full-stack web development bootcamp with on-the-job training for web development and software engineering.",
      "Learned algorithms, data structures, React, Node.js, Django, Python, MongoDB, and modern web development practices.",
      "Built real-world project that led to program completion and helped secure next job opportunity.",
    ],
    technologies: [
      "React",
      "Node.js",
  ...
  },
  {
    ...
    company: "Kortivity",
    period: "Early 2019 – Mid 2019",
    location: "Austin, TX",
    type: "past",
    logo: "/kortivity-logo.png",
    note: "Recruiting CRM startup • web crawler development",
    highlights: [
      { icon: "Code", text: "Web crawler development", metric: false },
      { icon: "Rocket", text: "Production launch", metric: true },
      { icon: "Target", text: "Database extensions", metric: false },
      { icon: "Zap", text: "Job profile data gathering", metric: false },
    ],
    achievements: [
      "Created, built, and launched to production a web crawler database extension that gathered future employee data from job profiles.",
      "Owned end-to-end development of data collection system for recruiting CRM platform, from design to deployment.",
    ],
    technologies: [
      "Node.js",
      "Python",
...
// ─── Redesign: concise Experience timeline ──────────────────────────────────
// Three entries, summary-only (no bullet lists). Copy is final as written in
// the redesign handoff; do not paraphrase. Consumed by ExperienceSection.tsx.
...
export const experiences: Experience[] = [
  {
    company: "Sproutflow Studio",
    role: "Founder & Solutions Consultant",
    period: "Oct 2025–Present",
    summary:
  ...
  },
  {
    ...
    role: "Senior Solutions Engineer / Cloud Infrastructure Engineer",
