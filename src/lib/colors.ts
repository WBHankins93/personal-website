...
// ─── Redesign: product status badge palette ─────────────────────────────────
// Editorial light theme. Each product state maps to a color-coded pill using
// the editorial tokens defined in globals.css.
